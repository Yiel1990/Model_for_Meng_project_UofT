...
out_ICML = model_ICML.predict_proba(inputdata,batch_size=128, verbose=1)
out_VGG = model_VGG.predict_proba(inputdata,batch_size=128, verbose=1)
out_VGG_19 =model_VGG_19.predict_proba(inputdata,batch_size=128, verbose=1)
